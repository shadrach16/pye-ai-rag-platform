"""
Django settings for humanressource project.
...
ROOT_URLCONF = 'humanressource.urls'
...
WSGI_APPLICATION = 'humanressource.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://pavilion-binary-infection-injuries.trycloudflare.com','https://*.127.0.0.1']
